...
/**
 * Guarda en SharedPreferences los datos del usuario autenticado.
 * Úsalo para saber quién está en sesión en cualquier parte de la app.
 */
class SessionManager(context: Context) {

    private val prefs: SharedPreferences =
        context.getSharedPreferences("minerva_session", Context.MODE_PRIVATE)
    ...
    fun estaLogueado(): Boolean = prefs.getBoolean(KEY_LOGGED, false)
    fun getIdUsuario(): String  = prefs.getString(KEY_ID,     "") ?: ""
